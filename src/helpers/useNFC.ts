// @see https://github.com/scholtz/vue-web-nfc-demo/blob/master/src/composition/useNFC.ts
import { _NDEFReader as NDEFReader } from './NDEFReader.ts';
...
export interface NFCInterface {
  ...
  is: ComputedRef<(nfcStatus: NFCStatus) => boolean>;
...
const is = computed(() => (nfcStatus: NFCStatus) => (_status.value[nfcStatus] ? true : false));
