...
const RAW_ROUTE_NAMES = {
  ...
  MEMBERS: {
    ...
    DETAIL: {
      ...
      TIMELINE: {
        INDEX: 'MEMBERS.DETAIL.TIMELINE.INDEX',
        ACTIVITY: {
          NEW: 'MEMBERS.DETAIL.TIMELINE.ACTIVITY.NEW',
          DETAIL: 'MEMBERS.DETAIL.TIMELINE.ACTIVITY.DETAIL',
        },
      },
      PROFILE: {
        INDEX: 'MEMBERS.DETAIL.PROFILE.INDEX',
      },
      ORDERS: {
        INDEX: 'MEMBERS.DETAIL.ORDERS.INDEX',
        TICKETS: {
          NEW: 'MEMBERS.DETAIL.ORDERS.TICKETS.NEW',
          DETAIL: 'MEMBERS.DETAIL.ORDERS.TICKETS.DETAIL',
        },
        SUBSCRIPTIONS: {
          NEW: 'MEMBERS.DETAIL.ORDERS.SUBSCRIPTIONS.NEW',
          DETAIL: 'MEMBERS.DETAIL.ORDERS.SUBSCRIPTIONS.DETAIL',
        },
        MEMBERSHIPS: {
          NEW: 'MEMBERS.DETAIL.ORDERS.MEMBERSHIPS.NEW',
          DETAIL: 'MEMBERS.DETAIL.ORDERS.MEMBERSHIPS.DETAIL',
        },
      },
    },
  },
