          ...
          <div class="m-auto max-w-2xl lg:mx-0 lg:max-w-xl">
            <div class="hidden sm:mb-10 sm:flex">
              <div
                ...
                <a class="inline-flex flex-row items-center whitespace-nowrap font-semibold text-indigo-600"
                  href="https://www.coworking-metz.fr/">
                  {{ $t('login.headline.readMore') }}
                  <SvgIcon aria-hidden="true" class="ml-1 h-4 w-4" :path="mdiArrowRight"
                    type="mdi" />
                </a>
              </div>
            </div>
            ...
            <div class="mt-10 flex items-center gap-x-6">
              <a class="flex flex-row items-center gap-2 rounded-md bg-indigo-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
...
const PHOTOS = [
  ...
  'https://www.coworking-metz.fr/wp-content/uploads/2020/05/coworking-metz-open-space.jpg',
  'https://www.coworking-metz.fr/wp-content/uploads/2020/05/20200524_120251.jpg',
  'https://www.coworking-metz.fr/wp-content/uploads/2020/05/20200524_120331.jpg',
  'https://www.coworking-metz.fr/wp-content/uploads/2020/05/20200524_115020.jpg'
];
