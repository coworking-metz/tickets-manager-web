        ...
        <nav aria-label="Breadcrumb" class="flex overflow-x-auto px-3 max-sm:w-screen">
          <ol
            ...
            <li
              ...
              :key="`activity-frequency-${frequency.label}`"
              class="flex">
...
const frequencies = computed(() => [
  {
    label: i18n.t('stats.activity.frequency.value.yearly'),
    to: { name: ROUTE_NAMES.STATS.ACTIVITY.YEARLY },
  },
  {
    label: i18n.t('stats.activity.frequency.value.monthly'),
    to: { name: ROUTE_NAMES.STATS.ACTIVITY.MONTHLY },
  },
  {
    label: i18n.t('stats.activity.frequency.value.weekly'),
    to: { name: ROUTE_NAMES.STATS.ACTIVITY.WEEKLY },
  },
  {
    label: i18n.t('stats.activity.frequency.value.daily'),
    to: { name: ROUTE_NAMES.STATS.ACTIVITY.DAILY },
  },
]);
