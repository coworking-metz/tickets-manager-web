...
export enum AuditAction {
  ...
  MEMBER_SUBSCRIPTION_ADD = 'MEMBER_SUBSCRIPTION_ADD',
  MEMBER_SUBSCRIPTION_UPDATE = 'MEMBER_SUBSCRIPTION_UPDATE',
  MEMBER_SUBSCRIPTION_REMOVE = 'MEMBER_SUBSCRIPTION_REMOVE',
  ...
  KEYS_ACCESS_HUB = 'KEYS_ACCESS_HUB',
  KEYS_ACCESS_POULAILLER = 'KEYS_ACCESS_POULAILLER',
  KEYS_ACCESS_PTI_POULAILLER = 'KEYS_ACCESS_PTI_POULAILLER',
  ...
  AIR_CONDITIONER_TURN_ON = 'AIR_CONDITIONER_TURN_ON',
  AIR_CONDITIONER_TURN_OFF = 'AIR_CONDITIONER_TURN_OFF',
  AIR_CONDITIONER_SET_TARGET_TEMPERATURE = 'AIR_CONDITIONER_SET_TARGET_TEMPERATURE',
}
